    ...
    render() {
        ...
        if(this.state.isLoading){
            return(
                <div className="m-auto">
                    <h2 className="block w-3/12 text-center text-white text-xl m-auto"> loading . . .</h2>
                </div>
            )
        }
        ...
        return (
            <section >
                ...
                <h2 className="text-xl m-5 text-white">Weekly Trending</h2>
                    {
