...
import { NavLink } from 'react-router-dom';
 ...
 class DiscoverTv extends React.Component {
     ...
     FetchDiscover(){
         fetch(baseURL+`/discover/tv?api_key=${API_KEY}&with_networks=213`)
         .then((res) => res.json())
         .then((data) => {
             this.setState({
                 isLoading : false,
 ...
 <h2 className="block w-3/12 text-center text-white text-xl m-auto"> loading . . .</h2>                </div>
        ...
        return (
            <section className="-mt-20">
                ...
                <h2 className="text-2xl mx-2 text-white" id="discovertv">DiscoverTv </h2>
                    {
